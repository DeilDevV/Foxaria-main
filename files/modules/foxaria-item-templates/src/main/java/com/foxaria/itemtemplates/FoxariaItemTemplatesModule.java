...
import com.foxaria.itemtemplates.listener.ItemAbilityListener;
...
public final class FoxariaItemTemplatesModule implements FoxariaModule {
    ...
    public void start(ModuleContext context) {
        ...
        // Особые способности: взрывы, заморозка, самонаведение, вампиризм и т.д.
        context.plugin().getServer().getPluginManager().registerEvents(
            new ItemAbilityListener(context.plugin()),
            context.plugin()
        );
    }
