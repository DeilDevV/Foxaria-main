...
public final class EditorLoreSync {
    ...
    public static void refresh(JavaPlugin plugin, ItemStack stack) {
        ...
        // Если предмет уже переведён на новую систему (способности/редкость),
        // описанием управляет AbilityLoreRenderer — не вмешиваемся,
        // иначе два механизма начнут дописывать строки друг за другом.
        if (!com.foxaria.itemtemplates.ability.AbilityCodec.read(plugin, stack).isEmpty()) {
