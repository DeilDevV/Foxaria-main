...
rem Если нет JAVA_HOME — берём portable JDK из репозитория (.jdks\jdk-21*), скачанный скриптом или вручную
...
set "JAR=%REPO%\foxaria-bootstrap\build\libs\foxaria-bootstrap-0.1.0-SNAPSHOT.jar"
set "PL=%TS%plugins"
set "FD=%PL%\Foxaria"
set "MD=%FD%\modules"
set "RES=%REPO%\foxaria-bootstrap\src\main\resources"
...
echo.
echo OK: Foxaria.jar + config + messages + modules\*.yml copied to test-server\plugins
exit /b 0
