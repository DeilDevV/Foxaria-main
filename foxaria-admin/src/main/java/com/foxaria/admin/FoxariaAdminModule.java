...
public final class FoxariaAdminModule implements FoxariaModule {
    ...
    public void start(ModuleContext context) {
        ...
        if (StaffPanelSettings.registerPanelCommands(moderationYaml)) {
            register(plugin, "adminpanel", new AdminPanelCommand(menuManager, economyService, moderationService, securityService, rankService, auditService, context.messages(), context.configs()));
        } else {
        ...
        register(plugin, "auditlog", new AdminPanelCommand(menuManager, economyService, moderationService, securityService, rankService, auditService, context.messages(), context.configs()));
