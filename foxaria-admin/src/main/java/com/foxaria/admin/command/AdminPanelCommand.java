...
public final class AdminPanelCommand implements CommandExecutor {
    ...
    public AdminPanelCommand(MenuManager menuManager, EconomyService economyService, ModerationService moderationService, SecurityService securityService, RankService rankService, AuditService auditService, MessageService messages, ConfigService configs) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        menuManager.open(player, new AdminDashboardMenu(economyService, moderationService, securityService, rankService, auditService));
        return true;
    }
