...
REM Foxaria Auth backend start (Paper)
...
if not exist "%JAR%" (
  echo [ERROR] Не найден "%JAR%" в папке servers\auth
...
if errorlevel 1 (
  ...
  echo Установи Java 21+ и укажи JAVA_HOME, либо положи JDK в servers\auth\jdk
  pause
  exit /b 1
)
